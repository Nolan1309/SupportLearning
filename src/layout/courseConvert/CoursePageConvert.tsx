...
export const CoursePageConvert = () => {
  ...
  const [selectedTestContent, setSelectedTestContent] = useState<{
    test_id: number;
    type: "test";
    title: string;
  } | null>(null);
  const [selectedTestChapContent, setSelectedTestChapContent] = useState<{
    test_id: number;
    type: "test_chap";
    title: string;
  } | null>(null);
  ...
  useEffect(() => {
    if (videoId) {
      ...
      setSelectedTestChapContent(null);
      ...
      setCurrentContent("test_chap");
      setSelectedVideoContent(null);
      setSelectedTestContent(null);

      setSelectedTestChapContent({
      ...
      <div className="rbt-lesson-area bg-color-white vaohoc">
        <div className="rbt-lesson-content-wrapper vaohoc">
                                        ...
                                        lesson.video.video_id && (
                                          <li>
                                            <a
                                              ...
                                              className={`content-item test-item ${isVideoCompleted(
                                                chapter.chapter_id,
                                                lesson.lesson_id
                                              )
                                                ? "completed"
          ...
          {(() => {
            ...
            } else if (selectedTestContent) {
              const validCourseData = Array.isArray(courseData) ? courseData : [];
              return (
                <TestQuickConvert
                  isSidebarOpen={isSidebarOpen}
                  handleToggleSidebar={handleToggleSidebar}
            ...
            } else if (selectedTestChapContent) {
              return (
                <TestChapterConvert
                  isSidebarOpen={isSidebarOpen}
                  handleToggleSidebar={handleToggleSidebar}
                  content={selectedTestChapContent}
                  progressCheck={progressData}
                />
              );
            }
