...
const CoursePlayer: React.FC = () => {
  ...
  const [selectedTestChapterContent, setSelectedTestChapterContent] = useState<{
    test_id: number;
    type: "test_chapter";
    title: string;
  } | null>(null);
  ...
  const fetchVideoData = async (videoId: string) => {
    ...
    try {
      ...
      setSelectedVideoContent({
        ...
        url: videoData.url,
        documentUrl: videoData.documentUrl,
        documentShort: videoData.documentShort,
      });
    } catch (error) {
    ...
    <div className="course-demo-container">
      ...
      <div className="row">
        <CourseSideBarComponent
          ...
          openChapters={openChapters} // boolean array cho openChapters
          openLessons={openLessons} // object chứa boolean array cho openLessons
          setOpenChapters={setOpenChapters} // Pass the setter function
