...
export const CourseSidebar: React.FC<CourseSidebarProps> = ({
  ...
  const handleCheck = async (e: React.MouseEvent) => {
    ...
    if (courseType === "FREE" && isEnrolled === true) {
      handleGoToCoursePlayer(course.id);
    } else if (courseType === "FEE" && isEnrolled === false) {
    ...
    } else if (courseType === "FEE" && isEnrolled === true) {
      handleGoToCoursePlayer(course.id);
      // console.log("ggg");
    } else if (courseType === "FREE" && isEnrolled === false) {
      // console.log  ("ggg");
      try {
        const token = localStorage.getItem("authToken");
        ...
        const enrollData = await enrollResponse.text(); // Xử lý phản hồi dạng text
      ...
      <div className="item">
        ...
        <ul>
          <li>
            ...
            <p>
              <strong>Thời gian:</strong> <span>{course.duration}</span>
            </p>
          </li>
          <li>
            <svg
