...
export const CourseContent: React.FC<CourseContentProps> = ({ course , reviews }) => {
  ...
  return (
    <div className="courses-details__item-left">
      ...
      <ul className="pt-20 pb-20 d-flex flex-wrap align-items-center gap-3 gap-md-5 bor-top bor-bottom">
        <li className="mb-0">
      ...
      <div className="content mt-30 mb-30">
        <h3 className="fs-30 mb-20">Những gì bạn sẽ học</h3>
        {/* <p className="mb-20">{course.courseOutput}</p> */}
        <div dangerouslySetInnerHTML={{ __html: course.courseOutput }}></div>
      </div>
      <div className="content">
        <h3 className="fs-30 mb-20">Mô tả khóa học</h3>
